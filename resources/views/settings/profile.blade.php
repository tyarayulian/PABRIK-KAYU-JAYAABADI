        ...
        <div class="settings-card">
            ...
            <form id="profileForm" method="POST" action="{{ route('settings.profile.update') }}">
                ...
                <div class="form-group" id="nameGroup">
                    ...
                    <input type="text" id="nameInput" name="name" value="{{ Auth::user()->name }}" readonly>
                </div>

                <div class="form-group" id="emailGroup">
                    <label>Alamat Email</label>
                    <input type="email" id="emailInput" name="email" value="{{ Auth::user()->email }}" readonly>
                </div>

                <div class="form-group">
                    <label>Terdaftar Sejak</label>
                    <input type="text" value="{{ Auth::user()->created_at->format('d F Y, H:i') }}" readonly style="background-color: #f1f5f9; color: #64748b;">
                </div>
    ...
    <div class="settings-grid">
        ...
        <div class="settings-card">
            ...
            <div class="session-info">
                <p>IP Address: <span>{{ $_SERVER['REMOTE_ADDR'] ?? 'Unknown' }}</span></p>
