                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div id="stock-info" style="display: {{ $kasKeluar->product_id ? 'block' : 'none' }}; font-size: 11px; color: #1e2a78; margin-top: 6px; font-weight: 700;">
                                Sisa stok: <span id="stock-value">{{ $kasKeluar->product->stock ?? 0 }}</span> <span id="stock-unit">{{ $kasKeluar->product->unit ?? '' }}</span>
                            </div>
                        </div>
