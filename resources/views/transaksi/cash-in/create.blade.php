...
@section('breadcrumb', 'Transaksi > Kas Masuk > Tambah')
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <input type="text" id="amount" name="amount" placeholder="Rp 0" value="{{ old('amount') }}" class="form-control">
                        </div>

                        <div class="form-group full-width">
                            <label>Keterangan / Deskripsi</label>
                            <textarea name="description" placeholder="Misal: Pembayaran piutang dari Customer A" class="form-control" rows="3" style="resize: none;">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
