...
@section('breadcrumb', 'Transaksi > Kas Keluar > Tambah')
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="description" placeholder="Catatan transaksi..." class="form-control" rows="3" style="resize: none;">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
