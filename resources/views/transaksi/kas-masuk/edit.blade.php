            ...
            <div class="card-body">
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select id="category_id_main" class="form-control" onchange="handleMainCategoryChange(this)">
                                ...
                                @foreach($categories as $cat)
                                    <option value="{{ $cat->id }}" data-is-product="{{ $cat->is_product }}" {{ old('category_id', $kasMasuk->category_id) == $cat->id ? 'selected' : '' }}>
                                        {{ $cat->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div id="product-group" class="form-group full-width" style="display: {{ $kasMasuk->product_id ? 'block' : 'none' }};">
                            <label>Produk*</label>
                            ...
                            <div id="stock-info" style="display: {{ $kasMasuk->product_id ? 'block' : 'none' }}; font-size: 11px; color: #1e2a78; margin-top: 6px; font-weight: 700;">
                                Sisa stok: <span id="stock-value">{{ $kasMasuk->product->stock ?? 0 }}</span> <span id="stock-unit">{{ $kasMasuk->product->unit ?? '' }}</span>
                            </div>
                        </div>
                        ...
                        <div id="qty-price-group" class="form-group full-width" style="display: {{ $kasMasuk->product_id ? 'block' : 'none' }};">
                        ...
                        <div class="form-group full-width">
                            ...
                            <input type="text" id="amount" name="amount" placeholder="Rp 0" value="{{ old('amount', (int)$kasMasuk->amount) }}" class="form-control" {{ $kasMasuk->product_id ? 'readOnly' : '' }} style="background-color: {{ $kasMasuk->product_id ? '#f1f5f9' : '#f8fafc' }}">
                        </div>
