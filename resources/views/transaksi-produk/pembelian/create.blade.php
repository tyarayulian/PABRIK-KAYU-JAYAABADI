...
@section('breadcrumb', 'Transaksi > Pembelian > Tambah')
            ...
            <div class="card-body">
                ...
                <div class="form-section">
                    <div class="section-info">
                        ...
                        <p>Catat data pembelian baru ke dalam sistem.</p>
                    </div>
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select id="product_id" name="product_id" class="form-control" onchange="handleProductChange(this)" required>
                                ...
                                @foreach($products as $product)
                                    <option value="{{ $product->id }}" data-category-id="{{ $product->category_id }}" data-cost="{{ (int)$product->cost }}" data-unit="{{ $product->unit }}" {{ old('product_id') == $product->id ? 'selected' : '' }}>{{ $product->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <input type="text" name="hutan" placeholder="Contoh: Kalimantan, Jepara, Hutan Produksi Riau" value="{{ old('hutan') }}" class="form-control">
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="description" placeholder="Contoh: Pembelian kayu duren dari Mursalin" class="form-control" rows="3" style="resize: none;">{{ old('description') }}</textarea>
                        </div>
