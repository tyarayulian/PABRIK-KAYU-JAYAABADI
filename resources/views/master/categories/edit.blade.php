                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group full-width">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name', $category->name) }}" placeholder="Contoh: Pendapatan Lain-lain" required autofocus>
                        </div>

                        <div class="form-group full-width">
                            <label>Tipe Transaksi*</label>
                            <select name="type" class="form-control" required>
                                <option value="cash_in" {{ old('type', $category->type) == 'cash_in' ? 'selected' : '' }}>Pemasukan Kas (Cash In)</option>
                                <option value="cash_out" {{ old('type', $category->type) == 'cash_out' ? 'selected' : '' }}>Pengeluaran Kas (Cash Out)</option>
                            </select>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <select name="account_id" class="form-control">
                                ...
                                @foreach($allAccounts as $account)
                                    <option value="{{ $account->id }}" {{ old('account_id', $category->account_id) == $account->id ? 'selected' : '' }}>
