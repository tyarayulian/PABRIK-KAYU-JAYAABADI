...
@section('breadcrumb', 'Master Data > Akun')
...
<div class="stat-cards-grid">
    <div class="stat-card">
        ...
        <div class="stat-card-value">{{ $accounts->count() }}</div>
        <div class="stat-card-meta">Seluruh akun dalam sistem</div>
    </div>
    <div class="stat-card">
        <div class="stat-card-label">Kategori Akun</div>
        <div class="stat-card-value">{{ $accounts->pluck('type')->unique()->count() }}</div>
...
<div class="table-section">
    <div class="table-title-section">
        ...
        <div style="display: flex; gap: 12px; align-items: center;">
            <a href="{{ route('master.accounts.create') }}" class="btn-action btn-action-primary" style="background: #f0f4ff; color: #1e2a78; border: 1px solid #e2e8f0; box-shadow: none;">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td id="checkboxCell-{{ $account->id }}" style="display: none; text-align: center;">
                    <input type="checkbox" class="account-checkbox" value="{{ $account->id }}" onchange="toggleBulkDeleteBtn()" style="width: 16px; height: 16px; cursor: pointer;">
                </td>
                <td><span class="account-code">{{ $account->code }}</span></td>
                <td style="font-weight: 700; color: #1e2a78;">{{ $account->name }}</td>
                ...
                <td style="text-align: right; font-weight: 700; color: {{ $account->current_balance >= 0 ? '#059669' : '#ef4444' }};">
