...
<div class="stok-layout">
    ...
    <div class="wood-sidebar">
        ...
        <div style="margin-top: 30px; padding: 0 10px;">
            <a href="{{ route('master.products.create') }}" style="display: flex; align-items: center; gap: 10px; color: #1e2a78; font-weight: 800; font-size: 13px; text-decoration: none;">
    ...
    <div class="stok-main">
        ...
        <div id="wood-{{ \Str::slug($woodType ?: 'lain-lain') }}" class="wood-content {{ $loop->first ? 'active' : '' }}">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
                ...
                <a href="{{ route('master.products.create', ['wood_type' => $woodType]) }}" class="btn-tambah-kategori">
                    <i class="fas fa-plus-circle"></i> Tambah Kategori {{ $woodType }}
                </a>
            </div>
                ...
                <div class="product-card" id="product-{{ $firstProduct->id }}">
                    <div class="product-card-header">
                        <div class="product-title-group">
                            <h2 style="font-size: 1.5rem; color: #1e2a78; font-weight: 800;">{{ $size ?: $firstProduct->name }}</h2>
                        ...
                        <div style="display: flex; gap: 12px; align-items: center;">
                            <button type="button" class="btn-jual" style="border-color: #fecaca; color: #ef4444;" onclick="confirmDeleteHistory('{{ route('master.products.destroy', $firstProduct->id) }}', 'initial')">
