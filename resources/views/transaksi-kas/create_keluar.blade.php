...
@section('breadcrumb', 'Transaksi Kas > Pengeluaran > Tambah')
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="description" placeholder="Contoh: Pembelian alat tulis kantor" class="form-control" rows="3" style="resize: none;">{{ old('description') }}</textarea>
                        </div>
