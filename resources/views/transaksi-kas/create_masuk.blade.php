...
@section('breadcrumb', 'Transaksi Kas > Pemasukan > Tambah')
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <input type="text" id="amount" name="amount" placeholder="Rp 0" value="{{ old('amount') }}" class="form-control" required>
                        </div>

                        <div class="form-group full-width">
                            <label>Keterangan / Deskripsi</label>
                            <textarea name="description" placeholder="Contoh: Penerimaan pembayaran dari pelanggan" class="form-control" rows="3" style="resize: none;">{{ old('description') }}</textarea>
                        </div>
