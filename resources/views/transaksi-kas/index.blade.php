    ...
    <div class="table-section" id="combinedTableSection">
        ...
        <div class="table-title-section">
            ...
            <div style="display: flex; gap: 12px; align-items: center;">
                <a href="{{ route('cash.in.create') }}" class="btn-action btn-action-primary" style="background: #f0f4ff; color: #1e2a78; border: 1px solid #e2e8f0; box-shadow: none;">
                    <i class="fas fa-plus"></i> Pemasukan
                </a>
                <a href="{{ route('cash.out.create') }}" class="btn-action btn-action-primary" style="background: #fff1f2; color: #f43f5e; border: 1px solid #ffe4e6; box-shadow: none;">
