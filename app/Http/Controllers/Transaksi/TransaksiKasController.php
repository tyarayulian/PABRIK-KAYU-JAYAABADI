...
class TransaksiKasController extends Controller
{
    public function index()
    {
        ...
        return view('transaksi-kas.index', compact('cashIns', 'cashOuts', 'allTransactions', 'akunMasuk', 'akunKeluar'));
    }
    ...
    public function createIn()
    {
        ...
        $cashAccounts = \App\Models\ChartOfAccount::where('is_active', true)
            ->where('type', 'asset')
            ->where(function($q) {
        ...
        return view('transaksi-kas.create_masuk', compact('categories', 'cashAccounts'));
    }
    ...
    public function createOut()
    {
        ...
        return view('transaksi-kas.create_keluar', compact('categories', 'cashAccounts'));
    }
    ...
    public function editIn($id)
    {
        ...
        return view('transaksi-kas.edit_masuk', compact('kasMasuk', 'categories', 'cashAccounts'));
    }
    ...
    public function editOut($id)
    {
        ...
        return view('transaksi-kas.edit_keluar', compact('kasKeluar', 'categories', 'cashAccounts'));
    }
