...
class ReturPenjualanController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = SalesReturn::with(['product', 'account', 'returnAccount', 'kasMasuk'])
            ->orderBy('date', 'desc');
        ...
        return view('transaksi-produk.retur-penjualan.index', compact(
            'salesReturns', 'totalReturnAmount', 'totalReturnQty', 'returnCount',
    ...
    public function create(Request $request)
    {
        ...
        if (!$saleId) {
            ...
            return view('transaksi-produk.retur-penjualan.select-sale', compact('sales'));
        }
        ...
        return view('transaksi-produk.retur-penjualan.create', compact('sale', 'maxQty'));
    }
    ...
    public function edit(SalesReturn $salesReturn)
    {
        ...
        return view('transaksi-produk.retur-penjualan.edit', compact('salesReturn', 'sale', 'maxQty'));
    }
