    ...
    <div class="table-section">
                        ...
                        <tr>
                            <?php if($loop->first): ?>
                                ...
                                <td style="color: #64748b; font-weight: 500;">
                                    ...
                                    <div style="font-size: 11px; color: #94a3b8; margin-top: 2px;"><?php echo e($group['date']->format('H:i')); ?></div>
                                </td>
                            <?php else: ?>
                                <td></td><td></td>
                            <?php endif; ?>
                            <td>
                                <div style="display: flex; flex-direction: column;">
                                    ...
                                    <span style="font-size: 11px; color: #94a3b8;"><?php echo e($entry->account->code); ?></span>
                                </div>
                            </td>
                            <?php if($loop->first): ?>
                                <td style="font-weight: 700; color: #1e293b;"><?php echo e($group['reference'] ?? '-'); ?></td>
                            <?php else: ?>
                                <td></td>
                            <?php endif; ?>
        ...
        <?php if($journals->hasPages()): ?>
            <div class="pagination-container" style="padding: 30px; border-top: 1px solid #f1f5f9;">
                <?php echo e($journals->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/report/journal.blade.php ENDPATH**/ ?>