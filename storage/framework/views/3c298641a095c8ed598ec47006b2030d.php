    ...
    <div class="table-section" id="combinedTableSection">
        ...
        <div class="table-title-section">
            ...
            <div style="display: flex; gap: 12px; align-items: center;">
                <a href="<?php echo e(route('cash.in.create')); ?>" class="btn-action btn-action-primary">
                    <i class="fas fa-plus"></i> Pemasukan
                </a>
                <a href="<?php echo e(route('cash.out.create')); ?>" class="btn-action btn-action-primary" style="background: #dc2626;">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $allTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div data-transaction-id="<?php echo e($transaction['id']); ?>" data-transaction-type="<?php echo e($transaction['type']); ?>" data-amount="Rp<?php echo e(number_format($transaction['amount'], 0, ',', '.')); ?>" class="transaction-row">
                    ...
                    <div style="text-align: left;">
                        <?php if($transaction['file_path']): ?>
                            <div style="position: relative; display: inline-block;">
                                ...
                                ?>
                                <?php if($isImage): ?>
                                    <img src="<?php echo e($fileUrl); ?>" style="width: 36px; height: 36px; border-radius: 8px; object-fit: cover; cursor: pointer; border: 1px solid #e2e8f0;" onclick="openViewer('<?php echo e($fileUrl); ?>', 'image')">
                                <?php else: ?>
                                    <div style="width: 36px; height: 36px; border-radius: 8px; background: #f1f5f9; display: flex; align-items: center; justify-content: center; cursor: pointer;" onclick="openViewer('<?php echo e($fileUrl); ?>', 'file')">
                    ...
                    <div style="text-align: left; display: flex; gap: 8px; align-items: center;">
                        <button style="background: #f1f5f9; color: #1e293b; border: 1px solid #e2e8f0; width: 34px; height: 34px; border-radius: 10px; cursor: pointer; display: flex; align-items: center; justify-content: center;" onclick="showTransactionDetail(<?php echo e($transaction['id']); ?>, '<?php echo e($transaction['type']); ?>')"><i class="fas fa-eye"></i></button>
                        
                        <button style="background: #f8fafc; color: #1e2a78; border: 1px solid #e2e8f0; width: 34px; height: 34px; border-radius: 10px; cursor: pointer; display: flex; align-items: center; justify-content: center;" onclick="editTransaction('<?php echo e($transaction['type']); ?>', <?php echo e($transaction['id']); ?>)"><i class="fas fa-edit"></i></button>
                        
                        <button style="background: #fff1f2; color: #f43f5e; border: 1px solid #ffe4e6; width: 34px; height: 34px; border-radius: 10px; cursor: pointer; display: flex; align-items: center; justify-content: center;" onclick="deleteTransaction('<?php echo e($transaction['type']); ?>', <?php echo e($transaction['id']); ?>)"><i class="fas fa-trash"></i></button>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/cash/index.blade.php ENDPATH**/ ?>