    ...
    <div class="register-card">
        ...
        <form method="POST" action="/register">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" placeholder="Masukkan nama lengkap" required value="<?php echo e(old('name')); ?>">
            </div>
...
<?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/auth/register.blade.php ENDPATH**/ ?>