    ...
    <div class="wood-sidebar">
        <div class="wood-sidebar-title">
            ...
            <div style="display: flex; gap: 4px;">
                <a href="<?php echo e(route('master.products.create')); ?>" class="btn-icon btn-icon-add" title="Tambah Produk Baru" style="width: 24px; height: 24px; font-size: 10px; border-radius: 6px;">
        ...
        <div class="wood-nav">
            ...
            <?php $firstProd = $categories->flatten()->first(); ?>
            <div class="wood-nav-item <?php echo e($loop->first ? 'active' : ''); ?>" 
                 data-wood-name="<?php echo e(strtoupper($woodType ?: 'Jenis Kayu Lain')); ?>"
                ...
                <div class="wood-item-actions" onclick="event.stopPropagation()">
                    <?php if($firstProd): ?>
                    <a href="<?php echo e(route('master.products.edit', $firstProd->id)); ?>" class="wood-action-btn wood-action-edit" title="Edit">
                        <i class="fas fa-edit"></i>
                    </a>
                    <button type="button" class="wood-action-btn wood-action-delete" title="Hapus"
                            onclick="confirmDeleteHistory('<?php echo e(route('master.products.destroy', $firstProd->id)); ?>', 'initial')">
                        ...
                        <div class="product-title-group">
                            <div>
                                <div style="font-size: 11px; font-weight: 700; color: #94a3b8; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px;">
                                    <?php echo e($woodType); ?> &rsaquo; <?php echo e($categoryName); ?>

                                </div>
                                <h2 style="font-size: 1.5rem; color: #1e2a78; font-weight: 800; margin: 0;"><?php echo e($size ?: $firstProduct->name); ?></h2>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <div style="display: flex; gap: 8px; justify-content: center;">
                                                ...
                                                <a href="<?php echo e($editUrl); ?>" class="btn-action-circle" title="Edit Stok">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                        ...
                                                        <table style="width: 100%; border: none;">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr style="background: transparent;">
                                                                    ...
                                                                    <td style="padding: 12px 20px; border-bottom: 1px solid #f1f5f9; background: transparent; text-align: right; color: <?php echo e(isset($sold['type']) && $sold['type'] === 'return' ? '#10b981' : '#ef4444'); ?>; font-weight: 800;">
                                                                        <?php if(isset($sold['type']) && $sold['type'] === 'return'): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/master/produk-dan-stok/index.blade.php ENDPATH**/ ?>