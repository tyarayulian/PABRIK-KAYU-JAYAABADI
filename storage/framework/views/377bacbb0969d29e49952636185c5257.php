...
<?php $__env->startSection('breadcrumb', 'Transaksi Kas > Pengeluaran > Tambah'); ?>
...
<div class="page-container">
    <div class="card">
        ...
        <form action="<?php echo e(route('cash.out.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="card-body">
                ...
                <div class="form-section">
                    <div class="section-info">
                        ...
                        <p>Masukkan detail transaksi pengeluaran kas operasional harian.</p>
                    </div>
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="description" placeholder="Contoh: Pembelian alat tulis kantor" class="form-control" rows="3" style="resize: none;"><?php echo e(old('description')); ?></textarea>
                        </div>
            ...
            <div class="card-footer">
                <button type="submit" class="btn-save">Simpan Pengeluaran</button>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/transaksi-kas/create_keluar.blade.php ENDPATH**/ ?>