...
<div class="page-container">
    <div class="card">
        ...
        <form action="<?php echo e(route('master.categories.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group full-width">
                            ...
                            <input type="text" name="name" class="form-control" value="<?php echo e(old('name')); ?>" placeholder="Contoh: Pendapatan Lain-lain" required autofocus>
                        </div>

                        <div class="form-group full-width">
                            <label>Tipe Transaksi*</label>
                            <select name="type" class="form-control" required>
                                <option value="cash_in" <?php echo e(old('type') == 'cash_in' ? 'selected' : ''); ?>>Pemasukan Kas (Cash In)</option>
                                <option value="cash_out" <?php echo e(old('type') == 'cash_out' ? 'selected' : ''); ?>>Pengeluaran Kas (Cash Out)</option>
                            </select>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/master/categories/create.blade.php ENDPATH**/ ?>