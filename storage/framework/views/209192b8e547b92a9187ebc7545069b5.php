...
<div class="dashboard-header-wrapper">
    <div class="details-header">
        <div class="details-nav">
            <h1 class="greeting-text"><?php echo e($greeting); ?>, <?php echo e($firstName); ?>!</h1>
        </div>
        <div class="user-welcome">
            <a href="<?php echo e(route('settings.profile')); ?>" class="header-action-btn" title="Pengaturan Akun">
            ...
            <div class="user-profile-circle"><?php echo e($initials); ?></div>
        </div>
    </div>
</div>
...
<div class="top-dashboard-section">
    <?php if(count($latestTransactions ?? []) > 0): ?>
        <?php $first = $latestTransactions[0]; ?>
                    ...
                    <div class="summary-container">
                        <div class="summary-header" style="justify-content: space-between; align-items: flex-end; padding: 0 5px;">
                            <div class="chart-header-info" style="text-align: left; display: flex; flex-direction: column;">
                                <span class="chart-header-amount" id="detailAmount" style="font-size: 18px; margin-bottom: 2px;">Rp<?php echo e(number_format($netBalance, 0, ',', '.')); ?></span>
                            ...
                            <div class="period-info" style="display: flex; flex-direction: column; align-items: flex-end;">
                                ...
                                <h2 class="period-value" id="detailPeriodLabel" style="font-size: 14px;"><?php echo e($periodLabel); ?></h2>
                            </div>
                        </div>
                        ...
                        <div class="summary-grid" style="gap: 15px; grid-template-columns: 1.2fr 0.8fr;">
                            ...
                            <div class="summary-card" style="padding: 15px; border-radius: 20px;">
                                ...
                                <div class="card-value" id="detailBalanceToday" style="font-size: 16px; margin-bottom: 5px;">Rp<?php echo e(number_format($balanceToday, 0, ',', '.')); ?></div>
                                <div class="card-footer" style="gap: 8px; font-size: 10px;">
                                    <div class="footer-item">
                                        <span class="footer-label">Penjualan</span>
                                        <span class="footer-val val-dark" id="detailCashInToday">Rp<?php echo e(number_format($cashInToday, 0, ',', '.')); ?></span>
                                    </div>
                                    <div class="footer-item">
                                        <span class="footer-label">Pembelian</span>
                                        <span class="footer-val val-red" id="detailCashOutToday">Rp<?php echo e(number_format($cashOutToday, 0, ',', '.')); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="summary-card" style="padding: 15px; border-radius: 20px;">
                                ...
                                <div class="card-value" id="detailTotalTransactions" style="font-size: 16px; margin-bottom: 5px;"><?php echo e($totalTransactions); ?></div>
                                <div class="card-footer">
                                    <a href="<?php echo e(route('transaksi.index')); ?>" class="footer-link" style="font-size: 10px;">Lihat <i class="fas fa-chevron-right"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="summary-grid" style="gap: 15px; margin-top: 15px; grid-template-columns: 1fr 1fr;">
                            ...
                            <div class="summary-card" style="padding: 15px; border-radius: 20px;">
                                ...
                                <div class="card-value" id="detailTotalKasMasuk" style="font-size: 16px; margin-bottom: 5px;">Rp<?php echo e(number_format($totalKasMasuk, 0, ',', '.')); ?></div>
                                <div class="card-footer" style="font-size: 10px;">
                                    <span class="footer-val val-dark" id="detailCashInPercentage"><?php echo e($cashInPercentageTotal); ?>%</span>
                            ...
                            <div class="summary-card" style="padding: 15px; border-radius: 20px;">
                                ...
                                <div class="card-value" id="detailTotalKasKeluar" style="font-size: 16px; margin-bottom: 5px;">Rp<?php echo e(number_format($totalKasKeluar, 0, ',', '.')); ?></div>
                                <div class="card-footer" style="font-size: 10px;">
                                    <span class="footer-val val-dark" id="detailCashOutPercentage"><?php echo e($cashOutPercentageTotal); ?>%</span>
            ...
            <div class="top-products-container">
                <div class="top-products-header">
                    ...
                    <div class="period-info">
                        ...
                        <div class="period-value" style="font-size: 14px;"><?php echo e($periodLabel); ?></div>
                    </div>
                </div>
                ...
                <div class="top-products-list" id="topProductsList">
                    <?php $__empty_1 = true; $__currentLoopData = $topProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="product-item">
                            <div class="product-rank rank-<?php echo e($index + 1); ?>">
                                <?php echo e($index + 1); ?>
                            ...
                            <div class="product-value">
                                <div class="product-qty"><?php echo e(number_format($product['total'], 0, ',', '.')); ?></div>
                    ...
                    <div class="summary-actions">
                        <div class="period-filter-container">
                            <select class="period-filter-select" onchange="filterPeriod(this.value)">
                                <option value="all" <?php echo e($periodType === 'all' ? 'selected' : ''); ?>>Semua Data</option>
                                <option value="current_month" <?php echo e($periodType === 'current_month' ? 'selected' : ''); ?>>Bulan Ini</option>
                                <?php $__currentLoopData = [1 => 'Januari', 2 => 'Februari', 3 => 'Maret', 4 => 'April', 5 => 'Mei', 6 => 'Juni', 7 => 'Juli', 8 => 'Agustus', 9 => 'September', 10 => 'Oktober', 11 => 'November', 12 => 'Desember']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="month:<?php echo e($val); ?>" <?php echo e(($periodType === 'month' && (int)$periodMonth === $val) ? 'selected' : ''); ?>><?php echo e($name); ?></option>
        ...
        <div class="recents-header">
            ...
            <div class="dropdown-transaction">
                ...
                <div class="dropdown-menu-custom" id="transactionDropdownMenu">
                    ...
                    <a href="<?php echo e(route('kas-masuk.create')); ?>"><i class="fas fa-shopping-cart"></i> + Penjualan</a>
                    <a href="<?php echo e(route('kas-keluar.create')); ?>"><i class="fas fa-cart-plus"></i> + Pembelian</a>
                    <div class="dropdown-divider"></div>
                    <div class="dropdown-section-label">TRANSAKSI KAS</div>
                    <a href="<?php echo e(route('cash.in.create')); ?>"><i class="fas fa-arrow-left"></i> + Kas Masuk</a>
                    <a href="<?php echo e(route('cash.out.create')); ?>"><i class="fas fa-arrow-right"></i> + Kas Keluar</a>
                </div>
            </div>
        </div>

        <div class="transaction-list" id="latestTransactionsList">
            <?php $__empty_1 = true; $__currentLoopData = $latestTransactions ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="transaction-item <?php echo e($index === 0 ? 'active' : ''); ?>" onclick="selectTransaction(<?php echo e($index); ?>)">
                    <div class="icon-box-round <?php echo e($transaction['type'] === 'in' ? 'icon-in' : 'icon-out'); ?>">
                        <i class="fas <?php echo e($transaction['type'] === 'in' ? 'fa-arrow-left' : 'fa-arrow-right'); ?>"></i>
                    </div>
                    <div class="item-info">
                        <div class="item-title">Rp<?php echo e($transaction['amount']); ?></div>
                        <div class="item-subtitle"><?php echo e($transaction['category']); ?></div>
                    </div>
                    <div class="item-meta" style="text-align: right;">
                        <?php if(isset($transaction['notes']) && $transaction['notes'] === 'RETUR'): ?>
                        ...
                        <?php endif; ?>
                        <div class="item-subtitle" style="font-size: 10px;"><?php echo e($transaction['date']); ?></div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<script>
    const transactions = <?php echo json_encode($latestTransactions ?? []); ?>;
...
<script>
    ...
    let trendChart;
    const sparklineData = <?php echo json_encode($sparklineData ?? []); ?>;
    ...
    new AutoRefresh({
        apiUrl: "<?php echo e(route('api.dashboard.data')); ?>?period_type=<?php echo e($periodType); ?>&period_month=<?php echo e($periodMonth); ?>&start_date=<?php echo e($startDate); ?>&end_date=<?php echo e($endDate); ?>",
        interval: 10000,
        onUpdate: (data) => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/dashboard.blade.php ENDPATH**/ ?>