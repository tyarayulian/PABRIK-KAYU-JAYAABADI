...
<div class="page-container">
    <div class="card">
        ...
        <form action="<?php echo e(route('kas-masuk.store')); ?>" method="POST" enctype="multipart/form-data" onsubmit="return validateStokBeforeSubmit()">
            <?php echo csrf_field(); ?>
            ...
            <div class="card-body">
                ...
                <div class="form-section">
                    <div class="section-info">
                        ...
                        <p>Masukkan detail transaksi penjualan produk kayu Anda.</p>
                    </div>
                    <div class="form-grid">
...
<script>
    ...
    function handleProductChange(select) {
        ...
        if (select.value) {
            ...
            // Ensure stock doesn't show negative value, tampilkan angka bulat
            const displayStock = stock < 0 ? 0 : Math.floor(stock);
            stockValue.textContent = displayStock;
            stockUnit.textContent = (unit && unit.toLowerCase() !== 'perkubik') ? unit : 'kubik';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/transaksi-produk/penjualan/create.blade.php ENDPATH**/ ?>