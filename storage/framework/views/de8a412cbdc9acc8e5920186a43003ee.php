...
<script>
    ...
    function handleProductChange(select) {
        ...
        if (select.value) {
            ...
            // Ensure stock doesn't show negative value
            const displayStock = stock < 0 ? 0 : stock;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/transaksi/kas-masuk/create.blade.php ENDPATH**/ ?>