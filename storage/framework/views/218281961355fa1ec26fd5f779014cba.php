...
<?php $__env->startSection('breadcrumb', 'Transaksi Kas > Pemasukan > Tambah'); ?>
...
<div class="page-container">
    <div class="card">
        <div class="card-header">
            <h2>Tambah Pemasukan Kas</h2>
            <a href="<?php echo e(route('cash.index')); ?>" class="btn-cancel-header">
                <i class="fas fa-times"></i> Batal
            </a>
        </div>

        <form action="<?php echo e(route('cash.in.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="card-body">
                ...
                <div class="form-section">
                    <div class="section-info">
                        ...
                        <p>Masukkan detail transaksi pemasukan kas operasional harian.</p>
                    </div>
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <input type="text" id="amount" name="amount" placeholder="Rp 0" value="<?php echo e(old('amount')); ?>" class="form-control" required>
                        </div>

                        <div class="form-group full-width">
                            <label>Keterangan / Deskripsi</label>
                            <textarea name="description" placeholder="Contoh: Penerimaan pembayaran dari pelanggan" class="form-control" rows="3" style="resize: none;"><?php echo e(old('description')); ?></textarea>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <select name="payment_account_id" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $cashAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($acc->id); ?>" <?php echo e(old('payment_account_id') == $acc->id ? 'selected' : ''); ?>>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        if (amountInput.value) {
            amountInput.value = formatNumber(parseCurrency(amountInput.value));
        }
        ...
        amountInput.addEventListener('blur', function () {
            // strip formatting before submit is handled by form submit
        });
    });
    ...
    function handleFileSelect(input) {
        ...
        if (input.files && input.files[0]) {
            ...
            btnView.onclick = (e) => { e.preventDefault(); e.stopPropagation(); openViewer(fileUrl, file.name); };
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/transaksi-kas/create_masuk.blade.php ENDPATH**/ ?>