<?php $__env->startSection('title', 'Master Kategori'); ?>
...
<div class="table-section">
    <div class="table-title-section">
        <div>
            ...
            <p>Menampilkan total <strong><?php echo e($categories->total()); ?></strong> kategori</p>
        </div>
        <div style="display: flex; gap: 12px; align-items: center;">
            <a href="<?php echo e(route('master.categories.create')); ?>" class="btn-action btn-action-primary" style="background: #f0f4ff; color: #1e2a78; border: 1px solid #e2e8f0; box-shadow: none;">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td id="checkboxCell-<?php echo e($category->id); ?>" style="display: none; text-align: center;">
                    <input type="checkbox" class="category-checkbox" value="<?php echo e($category->id); ?>" onchange="toggleBulkDeleteBtn()" style="width: 16px; height: 16px; cursor: pointer;">
                </td>
                <td style="font-weight: 700; color: #1e2a78;"><?php echo e($category->name); ?></td>
                <td>
                    <span class="badge-modern <?php echo e($category->type == 'cash_in' ? 'badge-cash-in' : 'badge-cash-out'); ?>">
                        <?php echo e($category->type == 'cash_in' ? 'Masuk' : 'Keluar'); ?>
                ...
                <td>
                    ...
                    <span class="account-link">
                        <?php echo e($category->account->code); ?> — <?php echo e($category->account->name); ?>
                ...
                <td>
                    <div style="display: flex; gap: 8px; justify-content: center;">
                        <a href="<?php echo e(route('master.categories.edit', $category->id)); ?>" class="action-btn" title="Edit">
                            <i class="fas fa-edit" style="color: #1e2a78;"></i>
                        </a>
                        <button class="action-btn btn-delete" title="Hapus" onclick="deleteCategory(<?php echo e($category->id); ?>)">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/master/kategori/index.blade.php ENDPATH**/ ?>