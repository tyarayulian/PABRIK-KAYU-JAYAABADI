...
<?php $__env->startSection('breadcrumb', 'Transaksi > Kas Masuk > Tambah'); ?>
    ...
    <div class="card">
        ...
        <form action="<?php echo e(route('cash.in.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-section">
                    <div class="section-info">
                        ...
                        <p>Masukkan detail dasar mengenai transaksi pemasukan kas Anda.</p>
                    </div>
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <input type="text" id="amount" name="amount" placeholder="Rp 0" value="<?php echo e(old('amount')); ?>" class="form-control">
                        </div>

                        <div class="form-group full-width">
                            <label>Keterangan / Deskripsi</label>
                            <textarea name="description" placeholder="Misal: Pembayaran piutang dari Customer A" class="form-control" rows="3" style="resize: none;"><?php echo e(old('description')); ?></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-footer">
                <button type="submit" class="btn-save">Simpan & Lanjutkan</button>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        if (typeof initCurrencyInput === 'function') {
            initCurrencyInput('#amount');
        }
    });
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/transaksi/cash-in/create.blade.php ENDPATH**/ ?>