...
<body>
    ...
    <script defer src="<?php echo e(asset('js/auto-refresh.js')); ?>"></script>
    <script defer src="<?php echo e(asset('js/toast.js')); ?>?v=<?php echo e(time()); ?>"></script>
    <script defer src="<?php echo e(asset('js/modal.js')); ?>?v=<?php echo e(time()); ?>"></script>
    <script defer src="<?php echo e(asset('js/swal-replacement.js')); ?>?v=<?php echo e(time()); ?>"></script>
