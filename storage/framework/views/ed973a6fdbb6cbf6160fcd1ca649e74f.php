...
<div class="header-card">
    ...
    <div class="filter-section">
        <form method="GET" action="<?php echo e(route('report.ledger')); ?>">
            <input type="hidden" name="filter_type" value="custom">
            <div class="filter-grid" style="align-items: flex-end;">
                <div class="filter-group">
                    <label>Mulai</label>
                    <input type="date" name="start_date" class="form-control" value="<?php echo e(is_string($startDate) ? $startDate : ($startDate ? $startDate->format('Y-m-d') : '')); ?>">
                </div>
                <div class="filter-group">
                    <label>Akhir</label>
                    <input type="date" name="end_date" class="form-control" value="<?php echo e(is_string($endDate) ? $endDate : ($endDate ? $endDate->format('Y-m-d') : '')); ?>">
                </div>
                <div class="filter-group">
                    <label>Akun</label>
                ...
                <a href="<?php echo e(route('report.ledger')); ?>" class="btn-reset" style="height: 36px; display: inline-flex; align-items: center; justify-content: center; white-space: nowrap;">Reset</a>
                
                <div style="display: flex; gap: 12px; margin-left: auto;">
                    <button type="button" onclick="window.print()" class="btn-outline" style="white-space: nowrap;">
                        <i class="fas fa-print"></i> PDF
                    </button>
                    <a href="<?php echo e(route('report.ledger.export', request()->all())); ?>" class="btn-outline" style="white-space: nowrap;">
...
<?php if(count($ledgerData) > 0): ?>
    <?php $__currentLoopData = $ledgerData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="account-card">
            <div class="account-banner">
                <div class="account-info">
                    <span class="account-code"><?php echo e($data['account']->code); ?> - </span>
                    <span class="account-name"><?php echo e($data['account']->name); ?></span>
                </div>
                <div class="account-type">Kategori: <?php echo e($data['account']->type); ?></div>
            </div>
            ...
            <table class="ledger-table">
                ...
                <tbody>
                    <tr>
                        <td style="color: #64748b; font-weight: 500; white-space: nowrap;">
                            ...
                            <?php elseif(count($data['transactions']) > 0): ?>
                                <?php echo e($data['transactions'][0]['journal']->journal_date->format('d M Y')); ?>
                        ...
                        <td class="amount" style="font-weight: 800; color: var(--primary-navy);">
                            <?php echo e(number_format($data['beginning_balance'], 0, ',', '.')); ?>
                    ...
                    <?php $__currentLoopData = $data['transactions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td style="color: #64748b; font-weight: 500; white-space: nowrap;">
                                <?php echo e($transaction['journal']->journal_date->format('d M Y')); ?>

                                <div style="font-size: 11px; color: #94a3b8; margin-top: 2px;"><?php echo e($transaction['journal']->journal_date->format('H:i')); ?></div>
                            </td>
                            <td>
                                <div style="font-weight: 600;">
                                    <?php echo e($transaction['journal']->description ?: $data['account']->name); ?>

                                </div>
                            </td>
                            <td style="font-size: 11px; color: var(--text-muted);">
                                <?php echo e($transaction['journal']->reference ?? '-'); ?>

                            </td>
                            <td class="amount text-debit">
                                <?php if($transaction['journal']->type === 'debit'): ?>
                                    <?php echo e(number_format($transaction['journal']->amount, 0, ',', '.')); ?>
                            ...
                            <td class="amount text-credit">
                                <?php if($transaction['journal']->type === 'credit'): ?>
                                    <?php echo e(number_format($transaction['journal']->amount, 0, ',', '.')); ?>
                ...
                <tfoot>
                    <tr class="balance-footer">
                        ...
                        <td class="amount text-debit"><?php echo e(number_format($data['debit_total'], 0, ',', '.')); ?></td>
                        <td class="amount text-credit"><?php echo e(number_format($data['credit_total'], 0, ',', '.')); ?></td>
                        <td class="amount highlight-balance">
                            <?php echo e(number_format($data['final_balance'], 0, ',', '.')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/report/ledger.blade.php ENDPATH**/ ?>