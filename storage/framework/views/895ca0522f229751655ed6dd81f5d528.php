...
<?php $__env->startSection('title', 'Tambah Kas Keluar'); ?>
<?php $__env->startSection('breadcrumb', 'Transaksi > Kas Keluar > Tambah'); ?>
            ...
            <div class="card-body">
                ...
                <div class="form-section">
                    <div class="section-info">
                        ...
                        <p>Masukkan detail dasar mengenai transaksi pengeluaran kas Anda.</p>
                    </div>
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="description" placeholder="Catatan transaksi..." class="form-control" rows="3" style="resize: none;"><?php echo e(old('description')); ?></textarea>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/transaksi/cash-out/create.blade.php ENDPATH**/ ?>