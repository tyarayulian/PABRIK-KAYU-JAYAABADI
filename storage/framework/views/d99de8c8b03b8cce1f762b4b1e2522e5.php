...
<div class="page-header">
    <a href="<?php echo e(route('sales-return.create')); ?>" class="btn-back" title="Ganti Penjualan">
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="info-sale">
            <div>
                ...
                <div style="font-size: 12px; color: #64748b; margin-top: 4px;">
                    <?php echo e($sale->date->format('d M Y')); ?> | Total: Rp <?php echo e(number_format($sale->amount, 0, ',', '.')); ?>
        ...
        <form action="<?php echo e(route('sales-return.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="1" id="quantity" name="quantity" max="<?php echo e($maxQty); ?>" placeholder="0" value="<?php echo e(old('quantity')); ?>" class="form-control" oninput="calculateAmount()" required>
                </div>

                <div class="form-group full-width">
                    <label>ESTIMASI NILAI RETUR (RP)</label>
                    <div class="amount-display-box" id="amount_text">Rp 0</div>
                    <input type="hidden" id="amount" name="amount" value="<?php echo e(old('amount')); ?>">
                    <small style="color: #94a3b8; margin-top: 8px; display: block; font-weight: 500;">
                        Otomatis: Qty x Harga Jual Asli (Rp <?php echo e(number_format($sale->price, 0, ',', '.')); ?>)
                    </small>
                </div>

                <div class="form-group full-width">
                    <label>ALASAN RETUR / KETERANGAN</label>
                    <textarea name="description" placeholder="Jelaskan alasan pengembalian (misal: barang cacat)..." class="form-control" rows="3" style="resize: none;"><?php echo e(old('description')); ?></textarea>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/transaksi/sales-return/create.blade.php ENDPATH**/ ?>