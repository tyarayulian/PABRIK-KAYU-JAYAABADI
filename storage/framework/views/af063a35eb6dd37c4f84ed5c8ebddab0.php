...
<div class="table-section">
    <div class="table-title-section">
        <div>
            ...
            <p style="font-size: 14px; color: #64748b; margin: 4px 0 0 0;">Menampilkan total <strong><?php echo e($returnCount); ?></strong> transaksi</p>
        </div>
    ...
    <div style="display: flex; gap: 16px; flex-wrap: nowrap; align-items: flex-end; padding: 20px 30px; background: white; border-bottom: 1px solid #f1f5f9;">
        <form method="GET" action="<?php echo e(route('sales-return.index')); ?>" style="display: flex; gap: 16px; flex-wrap: nowrap; align-items: flex-end; width: 100%;">
            <div style="display: flex; flex-direction: column; gap: 6px;">
                ...
                <input type="date" name="start_date" value="<?php echo e($startDate); ?>" style="padding: 10px 16px; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 14px; background: #f8fafc; height: 42px; box-sizing: border-box;">
            </div>
            <div style="display: flex; flex-direction: column; gap: 6px;">
                <label style="font-size: 11px; font-weight: 700; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.05em;">AKHIR</label>
                <input type="date" name="end_date" value="<?php echo e($endDate); ?>" style="padding: 10px 16px; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 14px; background: #f8fafc; height: 42px; box-sizing: border-box;">
            </div>
            <div style="display: flex; gap: 8px; align-items: flex-end; height: 42px;">
                ...
                <a href="<?php echo e(route('sales-return.index')); ?>" style="background: #f1f5f9; color: #64748b; border: 1px solid #e2e8f0; padding: 0 16px; height: 42px; border-radius: 12px; font-weight: 600; font-size: 14px; display: flex; align-items: center; text-decoration: none;">Reset</a>
            </div>
            <div style="flex: 1; min-width: 250px; margin-left: auto; display: flex; flex-direction: column; gap: 6px;">
                <div style="position: relative;">
                    ...
                    <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Cari produk atau keterangan..." style="width: 100%; padding: 10px 16px 10px 42px; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 14px; background: #f8fafc; height: 42px; box-sizing: border-box;">
                </div>
            </div>
        </form>
    </div>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <div style="display: flex; justify-content: center; gap: 8px;">
                                ...
                                <form id="deleteForm<?php echo e($return->id); ?>" action="<?php echo e(route('sales-return.destroy', $return->id)); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="button" class="btn-action btn-delete" title="Hapus" onclick="deleteReturn(<?php echo e($return->id); ?>, '<?php echo e($return->product->name ?? 'retur ini'); ?>')">
...
function deleteReturn(id, productName) {
    if (typeof Modal !== 'undefined') {
        Modal.delete(`retur ${productName}`, function() {
            ...
            fetch(`<?php echo e(url('/sales-return')); ?>/${id}`, {
                method: 'POST',
                body: formData,
                headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp4\htdocs\pabrik-kayu1\resources\views/transaksi-produk/retur-penjualan/index.blade.php ENDPATH**/ ?>